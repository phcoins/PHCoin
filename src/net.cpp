...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "PHCoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"phcoin.org", "phcoin.no-ip.biz"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"phcoin.org", "testnet-seed.no-ip.biz"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. PHCoin is probably already running."), addrBind.ToString().c_str());
        else
